        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              ...
              Discover hidden gems and create unforgettable memories with expert locals.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/guides" className="block text-gray-400 hover:text-white transition-colors">
                All Guides
              </Link>
