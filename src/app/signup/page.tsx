          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <div className="text-center">
              <Link href="/" className="inline-flex items-center space-x-2 mb-8">
                ...
                <span className="text-2xl font-bold text-gray-900">TravelGuide</span>
              </Link>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Create your account</h2>
              <p className="text-gray-600">Join our community and start your travel journey</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              >
                {isLoading ? (
                  ...
                  `Create ${userType === 'traveler' ? 'Traveler' : 'Guide'} Account`
                )}
              </button>
            </form>
              ...
              <div className="text-center text-white">
                <div className="mb-8">
                  ...
                  <p className="text-xl text-green-100 mb-8 max-w-md">
                    {userType === 'traveler' 
                      ? "Connect with amazing local guides and create unforgettable travel memories."
                      : "Share your local knowledge and earn money by guiding travelers through your city."
                    }
                  </p>
                </div>
                  ...
                  {userType === 'traveler' ? (
                    <>
                      <div className="flex items-center">
                        ...
                        <span>Access to verified guides worldwide</span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center mr-3">
                          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <>
                      <div className="flex items-center">
                        ...
                        <span>Earn money sharing your expertise</span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center mr-3">
                          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span>Flexible schedule and pricing</span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center mr-3">
                          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
